...
namespace My_elementor_extencion\Extras;
...
trait Helper
{
     ...
     * @return array
     */
    public function wee_get_all_types_post()
    {
        $posts = get_posts([
            'post_type' => 'any',
     ...
     *
     */
    protected function wee_query_controls()
    {
        $post_types = $this->wee_get_post_types();
        $post_types['by_id'] = __('Manual Selection', 'wee_elementor-test-extension');
        ...
        if ('eael-content-ticker' === $this->get_name()) {
            $this->start_controls_section(
                ...
                [
                    'label' => __('Dynamic Content Settings', 'wee_elementor-test-extension'),
                    'condition' => [
            ...
            $this->start_controls_section(
                ...
                [
                    'label' => __('Query', 'wee_elementor-test-extension'),
                ]
            );
        }
        ...
        $this->add_control(
            'post_type',
            [
                'label' => __('Source', 'wee_elementor-test-extension'),
        ...
        $this->add_control(
            'posts_ids',
            [
                'label' => __('Search & Select', 'wee_elementor-test-extension'),
                'type' => Controls_Manager::SELECT2,
                'options' => $this->wee_get_all_types_post(),
                'label_block' => true,
                'multiple' => true,
                'condition' => [
                    'post_type' => 'by_id',
        ...
        $this->add_control(
            'authors', [
                'label' => __('Author', 'wee_elementor-test-extension'),
                'label_block' => true,
                'type' => Controls_Manager::SELECT2,
                'multiple' => true,
                'default' => [],
                'options' => $this->wee_get_authors(),
                'condition' => [
                    'post_type!' => 'by_id',
                ],
            ]
        ...
        $this->add_control(
            'post__not_in',
            [
                'label' => __('Exclude', 'wee_elementor-test-extension'),
                'type' => Controls_Manager::SELECT2,
                'options' => $this->wee_get_all_types_post(),
                'label_block' => true,
                'post_type' => '',
        ...
        $this->add_control(
            'posts_per_page',
            [
                'label' => __('Posts Per Page', 'wee_elementor-test-extension'),
        ...
        $this->add_control(
            'offset',
            [
                'label' => __('Offset', 'wee_elementor-test-extension'),
                'type' => Controls_Manager::NUMBER,
                'default' => '0',
            ]
        );
        ...
        $this->add_control(
            'orderby',
            [
                'label' => __('Order By', 'wee_elementor-test-extension'),
                'type' => Controls_Manager::SELECT,
                'options' => $this->wee_get_post_orderby_options(),
                'default' => 'date',
        ...
        $this->add_control(
            'order',
            [
                'label' => __('Order', 'wee_elementor-test-extension'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'asc' => 'Ascending',
                    'desc' => 'Descending',
    ...
    protected function eael_betterdocs_content_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Content Area', 'wee_elementor-test-extension'),
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Padding', 'wee_elementor-test-extension'),
        ...
        $this->add_responsive_control(
            'content_area_width',
            [
                'label' => __('Width', 'wee_elementor-test-extension'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Max Width', 'wee_elementor-test-extension'),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 1600,
                    'unit' => 'px',
     ...
     *
     */
    protected function wee_layout_controls()
    {
        $this->start_controls_section(
            'wee_section_post_timeline_layout',
            [
                'label' => __('Layout Settings', 'wee_elementor-test-extension'),
            ]
        );
        ...
        if ('wee-post-grid' === $this->get_name()) {
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Number of Columns', 'wee_elementor-test-extension'),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'eael-col-4',
                    'options' => [
                        'eael-col-1' => esc_html__('Single Column', 'wee_elementor-test-extension'),
                        'eael-col-2' => esc_html__('Two Columns', 'wee_elementor-test-extension'),
                        'eael-col-3' => esc_html__('Three Columns', 'wee_elementor-test-extension'),
                        'eael-col-4' => esc_html__('Four Columns', 'wee_elementor-test-extension'),
                        'eael-col-5' => esc_html__('Five Columns', 'wee_elementor-test-extension'),
                        'eael-col-6' => esc_html__('Six Columns', 'wee_elementor-test-extension'),
                    ],
                ]
            );
        }

        if ('wee-post-block' === $this->get_name()) {
            $this->add_control(
                'grid_style',
                [
                    'label' => esc_html__('Post Block Style Preset', 'wee_elementor-test-extension'),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'post-block-style-default',
                    'options' => [
                        'post-block-style-default' => esc_html__('Default', 'wee_elementor-test-extension'),
                        'post-block-style-overlay' => esc_html__('Overlay', 'wee_elementor-test-extension'),
                    ],
                ]
            );
        }

        if ('wee-post-carousel' !== $this->get_name()) {

            /**
             * Show Read More
             * @uses ContentTimeLine Elements - EAE
             */
            if ('wee-content-timeline' === $this->get_name()) {

                $this->add_control(
                    'content_timeline_layout',
                    [
                        'label' => esc_html__('Layout', 'wee_elementor-test-extension'),
                        'type' => Controls_Manager::SELECT,
                        'default' => 'center',
                        'options' => [
                            'left'   => esc_html__('Right', 'wee_elementor-test-extension'),
                            'center' => esc_html__('Center', 'wee_elementor-test-extension'),
                            'right'  => esc_html__('Left', 'wee_elementor-test-extension'),
                        ],
                        'default'   => 'center'
                    ]
                );
                ...
                $this->add_control(
                    'date_position',
                    [
                        'label' => esc_html__('Date Position', 'wee_elementor-test-extension'),
                        'type' => Controls_Manager::SELECT,
                        'default' => 'inside',
                        'options' => [
                            'inside'   => esc_html__('Inside', 'wee_elementor-test-extension'),
                            'outside' => esc_html__('Outside', 'wee_elementor-test-extension')
                        ],
                        'default'   => 'inside',
                        'condition' => [
                ...
                $this->add_control(
                    'show_load_more',
                    [
                        'label' => __('Show Load More', 'wee_elementor-test-extension'),
                ...
                $this->add_control(
                    'show_load_more_text',
                    [
                        'label' => esc_html__('Label Text', 'wee_elementor-test-extension'),
                        'type' => Controls_Manager::TEXT,
                        'label_block' => false,
                        'default' => esc_html__('Load More', 'wee_elementor-test-extension'),
                        'condition' => [
                            'show_load_more' => 'yes',
                        ],
                    ]
        ...
        if ('wee-content-timeline' !== $this->get_name()) {
            $this->add_control(
                'wee_show_image',
                [
                    'label' => __('Show Image', 'wee_elementor-test-extension'),
                    'type'      => Controls_Manager::SWITCHER,
                    'label_on'  => __( 'Show', 'wee_elementor-test-extension' ),
                    'label_off' => __( 'Hide', 'wee_elementor-test-extension' ),
                    'return_value' => 'yes',
        ...
        if ('wee-content-timeline' === $this->get_name()) {
            ...
            $this->add_control(
                'wee_show_image_or_icon',
                [
                    'label' => __('Show Circle Image / Icon', 'wee_elementor-test-extension'),
                    'type' => Controls_Manager::CHOOSE,
                    'options' => [
                        'img' => [
                            'title' => __('Image', 'wee_elementor-test-extension'),
                            'icon' => 'fa fa-picture-o',
                        ],
                        'icon' => [
                            'title' => __('Icon', 'wee_elementor-test-extension'),
                            'icon' => 'fa fa-info',
                        ],
                        'bullet' => [
                            'title' => __('Bullet', 'wee_elementor-test-extension'),
                            'icon' => 'fa fa-circle',
                        ],
                    ],
                    'default' => 'icon',
            ...
            $this->add_control(
                'wee_icon_image',
                [
                    'label' => esc_html__('Icon Image', 'wee_elementor-test-extension'),
                    'type' => Controls_Manager::MEDIA,
                    'default' => [
                        'url' => Utils::get_placeholder_image_src(),
                    ],
                    'condition' => [
                        'wee_show_image_or_icon' => 'img',
                    ],
                ]
            );
            $this->add_control(
                'wee_icon_image_size',
                [
                    'label' => esc_html__('Icon Image Size', 'wee_elementor-test-extension'),
                    'type' => Controls_Manager::SLIDER,
                    'default' => [
                        'size' => 24,
                    ],
            ...
            $this->add_control(
                'wee_content_timeline_circle_icon_new',
                [
                    'label' => esc_html__('Icon', 'wee_elementor-test-extension'),
                    ...
                    'condition' => [
                        'wee_content_timeline_choose' => 'dynamic',
                        'wee_show_image_or_icon' => 'icon',
                    ],
                ]
            );
        ...
        $this->add_control(
            'wee_show_title',
            [
                'label' => __('Show Title', 'wee_elementor-test-extension'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => __( 'Show', 'wee_elementor-test-extension' ),
                'label_off' => __( 'Hide', 'wee_elementor-test-extension' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'wee_show_excerpt',
            [
                'label' => __('Show excerpt', 'wee_elementor-test-extension'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => __( 'Show', 'wee_elementor-test-extension' ),
                'label_off' => __( 'Hide', 'wee_elementor-test-extension' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'wee_excerpt_length',
            [
                'label' => __('Excerpt Words', 'wee_elementor-test-extension'),
                'type' => Controls_Manager::NUMBER,
                'default' => '10',
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Expanison Indicator', 'wee_elementor-test-extension'),
                'type' => Controls_Manager::TEXT,
                'label_block' => false,
                'default' => esc_html__('...', 'wee_elementor-test-extension'),
                'condition' => [
        ...
        $this->add_control(
            'wee_show_read_more',
            [
                'label' => __('Show Read More', 'wee_elementor-test-extension'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => __( 'Show', 'wee_elementor-test-extension' ),
                'label_off' => __( 'Hide', 'wee_elementor-test-extension' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => false,
                'default' => esc_html__('Read More', 'wee_elementor-test-extension'),
                'condition' => [
                    'wee_content_timeline_choose' => 'dynamic',
                    'wee_show_read_more' => 'yes',
                ],
            ]
        );
        ...
        if (
            ...
            $this->add_control(
                'wee_show_read_more_button',
                [
                    'label' => __('Show Read More Button', 'wee_elementor-test-extension'),
                    'type'      => Controls_Manager::SWITCHER,
                    'label_on'  => __( 'Show', 'wee_elementor-test-extension' ),
                    'label_off' => __( 'Hide', 'wee_elementor-test-extension' ),
                    'return_value' => 'yes',
            ...
            $this->add_control(
                ...
                [
                    'label' => __('Button Text', 'wee_elementor-test-extension'),
                    'type' => Controls_Manager::TEXT,
                    'default' => __('Read More', 'wee_elementor-test-extension'),
                    'condition' => [
                        'wee_show_read_more_button' => 'yes',
                    ],
                ]
            );
        }
        ...
        if ('wee-post-grid' === $this->get_name() || 'wee-post-block' === $this->get_name() || 'wee-post-carousel' === $this->get_name()) {
            ...
            $this->add_control(
                'wee_show_meta',
                [
                    'label' => __('Show Meta', 'wee_elementor-test-extension'),
                    'type'      => Controls_Manager::SWITCHER,
                    'label_on'  => __( 'Show', 'wee_elementor-test-extension' ),
                    'label_off' => __( 'Hide', 'wee_elementor-test-extension' ),
                    'return_value' => 'yes',
            ...
            $this->add_control(
                'meta_position',
                [
                    'label' => esc_html__('Meta Position', 'wee_elementor-test-extension'),
                    'type' => Controls_Manager::SELECT,
    ...
    protected function wee_read_more_button_style()
    {
        if (
            'wee-post-grid' === $this->get_name()
            || 'wee-post-block' === $this->get_name()
            ...
            || 'wee-post-timeline' === $this->get_name()
        ) {
            $this->start_controls_section(
                'wee_section_read_more_btn',
                [
                    'label' => __('Read More Button Style', 'wee_elementor-test-extension'),
            ...
            $this->add_group_control(
                ...
                [
                    'name' => 'wee_post_read_more_btn_typography',
            ...
            $this->start_controls_tabs('read_more_button_tabs');
                ...
                $this->start_controls_tab(
                    'wee_more_button_style_normal',
                    [
                        'label' => __( 'Normal', 'wee_elementor-test-extension' ),
                    ]
                );

                $this->add_control(
                    'wee_post_read_more_btn_color',
                    [
                        'label' => esc_html__('Text Color', 'wee_elementor-test-extension'),
                ...
                $this->add_group_control(
                    ...
                    [
                        ...
                        'label' => __( 'Background', 'wee_elementor-test-extension' ),
                        'types' => [ 'classic', 'gradient' ],
                        'selector' => '{{WRAPPER}} .eael-post-elements-readmore-btn',
                        'exclude' => [
                            'image'
                ...
                $this->add_group_control(
                    ...
                    [
                        ...
                        'label' => __( 'Border', 'wee_elementor-test-extension' ),
                        'selector' => '{{WRAPPER}} .eael-post-elements-readmore-btn',
                    ]
                );
                ...
                $this->start_controls_tab(
                    ...
                    [
                        'label' => __( 'Hover', 'wee_elementor-test-extension' ),
                    ]
                );

                $this->add_control(
                    'wee_post_read_more_btn_hover_color',
                    [
                        'label' => esc_html__('Text Color', 'wee_elementor-test-extension'),
                        'type' => Controls_Manager::COLOR,
                        'selectors' => [
            ...
            $this->add_responsive_control(
                'wee_post_read_more_btn_padding',
                [
                    'label' => esc_html__('Padding', 'wee_elementor-test-extension'),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => ['px', 'em', '%'],
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => esc_html__('Margin', 'wee_elementor-test-extension'),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => ['px', 'em', '%'],
                    'selectors' => [
     ...
     *
     */
    protected function wee_load_more_button_style()
    {
        $this->start_controls_section(
            'wee_section_load_more_btn',
            [
                'label' => __('Load More Button Style', 'wee_elementor-test-extension'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_load_more' => 'yes',
                ],
        ...
        $this->add_responsive_control(
            'wee_post_grid_load_more_btn_padding',
            [
                'label' => esc_html__('Padding', 'wee_elementor-test-extension'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
        ...
        $this->add_responsive_control(
            'wee_post_grid_load_more_btn_margin',
            [
                'label' => esc_html__('Margin', 'wee_elementor-test-extension'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'name' => 'wee_post_grid_load_more_btn_typography',
                'selector' => '{{WRAPPER}} .eael-load-more-button',
            ]
        );

        $this->start_controls_tabs('wee_post_grid_load_more_btn_tabs');

        // Normal State Tab
        $this->start_controls_tab('wee_post_grid_load_more_btn_normal', ['label' => esc_html__('Normal', 'wee_elementor-test-extension')]);

        $this->add_control(
            'wee_post_grid_load_more_btn_normal_text_color',
            [
                'label' => esc_html__('Text Color', 'wee_elementor-test-extension'),
                'type' => Controls_Manager::COLOR,
                'default' => '#fff',
        ...
        $this->add_control(
            'wee_cta_btn_normal_bg_color',
            [
                'label' => esc_html__('Background Color', 'wee_elementor-test-extension'),
                'type' => Controls_Manager::COLOR,
                'default' => '#29d8d8',
                'selectors' => [
        ...
        $this->add_group_control(
            Group_Control_Border::get_type(),
            [
                'name' => 'wee_post_grid_load_more_btn_normal_border',
        ...
        $this->add_control(
            'wee_post_grid_load_more_btn_border_radius',
            [
                'label' => esc_html__('Border Radius', 'wee_elementor-test-extension'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
        ...
        // Hover State Tab
        $this->start_controls_tab('wee_post_grid_load_more_btn_hover', ['label' => esc_html__('Hover', 'wee_elementor-test-extension')]);

        $this->add_control(
            'wee_post_grid_load_more_btn_hover_text_color',
            [
                'label' => esc_html__('Text Color', 'wee_elementor-test-extension'),
                'type' => Controls_Manager::COLOR,
                'default' => '#fff',
        ...
        $this->add_control(
            'wee_post_grid_load_more_btn_hover_bg_color',
            [
                'label' => esc_html__('Background Color', 'wee_elementor-test-extension'),
                'type' => Controls_Manager::COLOR,
                'default' => '#27bdbd',
        ...
        $this->add_control(
            'wee_post_grid_load_more_btn_hover_border_color',
            [
                'label' => esc_html__('Border Color', 'wee_elementor-test-extension'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_group_control(
            Group_Control_Box_Shadow::get_type(),
            [
                'name' => 'wee_post_grid_load_more_btn_hover_shadow',
        ...
        $this->add_responsive_control(
            'wee_post_grid_loadmore_button_alignment',
            [
                'label' => __('Button Alignment', 'wee_elementor-test-extension'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'flex-start' => [
    ...
    protected function eael_go_premium()
    {
        $this->start_controls_section(
            'eael_section_pro',
            [
                'label' => __('Go Premium for More Features', 'wee_elementor-test-extension'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Unlock more possibilities', 'wee_elementor-test-extension'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    '1' => [
                        'title' => __('', 'wee_elementor-test-extension'),
     ...
     * @return array
     */
    public function wee_get_post_types()
    {
     ...
     * @return array
     */
    public function wee_get_post_orderby_options()
    {
        $orderby = array(
            'ID' => 'Post ID',
            'author' => 'Post Author',
    ...
    public function eael_select_contact_form()
    {
        ...
        if (function_exists('wpcf7')) {
            ...
            $options[0] = esc_html__('Select a Contact Form', 'wee_elementor-test-extension');
            if (!empty($wpcf7_form_list) && !is_wp_error($wpcf7_form_list)) {
                foreach ($wpcf7_form_list as $post) {
                    $options[$post->ID] = $post->post_title;
                }
            } else {
                $options[0] = esc_html__('Create a Form First', 'wee_elementor-test-extension');
            }
        }
        return $options;
    }
    ...
    public function eael_select_gravity_form()
    {
        ...
        if (class_exists('GFCommon')) {
            ...
            if (!empty($gravity_forms) && !is_wp_error($gravity_forms)) {
                ...
                $options[0] = esc_html__('Select Gravity Form', 'wee_elementor-test-extension');
    ...
    public function eael_select_weform()
    {
        ...
        if (!empty($wpuf_form_list) && !is_wp_error($wpuf_form_list)) {
            $options[0] = esc_html__('Select weForm', 'wee_elementor-test-extension');
    ...
    public function eael_select_ninja_form()
    {
        ...
        if (class_exists('Ninja_Forms')) {
            ...
            if (!empty($contact_forms) && !is_wp_error($contact_forms)) {
                ...
                $options[0] = esc_html__('Select Ninja Form', 'wee_elementor-test-extension');
    ...
    public function eael_select_caldera_form()
    {
        ...
        if (class_exists('Caldera_Forms')) {
            ...
            if (!empty($contact_forms) && !is_wp_error($contact_forms)) {
                $options[0] = esc_html__('Select Caldera Form', 'wee_elementor-test-extension');
                foreach ($contact_forms as $form) {
    ...
    public function eael_select_wpforms_forms()
    {
        ...
        if (class_exists('\WPForms\WPForms')) {
            ...
            if (!empty($contact_forms) && !is_wp_error($contact_forms)) {
                $options[0] = esc_html__('Select a WPForm', 'wee_elementor-test-extension');
    ...
    public static function eael_select_fluent_forms()
    {
        ...
        if(defined('FLUENTFORM')) {
            ...
            if($result) {
                $options[0] = esc_html__('Select a Fluent Form', 'wee_elementor-test-extension');
     ...
     * @return array
     */
    public function wee_get_authors()
    {
        $users = get_users([
            'who' => 'authors',
    ...
    public function twitter_feed_render_items($id, $settings, $class = '')
    {
        ...
        foreach ($items as $item) {
            ...
            if ($settings['eael_twitter_feed_show_date'] == 'true') {
                $html .= '<span class="eael-twitter-feed-item-date">' . sprintf(__('%s ago', 'wee_elementor-test-extension'), human_time_diff(strtotime($item['created_at']))) . '</span>';
            }
            $html .= '</div>
    ...
    public function facebook_feed_render_items() {
        ...
        if (isset($_REQUEST['action']) && $_REQUEST['action'] == 'facebook_feed_load_more') {
            // check ajax referer
            check_ajax_referer('wee_elementor-test-extension', 'security');
