...
require_once  WEE_DIR_PATH . '/Templete/content/Post_Grid_Slider.php';
...
class wee_Post_Grid_Slider extends Widget_Base
{
    use \My_elementor_extencion\Extras\Helper;
    use \My_elementor_extencion\Template\content\Post_Grid_Slider;

    public function get_name()
    {
        return 'wee-post-grid-slider';
    }

    public function get_title()
    {
        return __('Wee Post Grid Slider', 'wee_elementor-test-extension');
    }
    ...
    public function get_style_depends(){
		...
		return [ 'my-post-grid-slider','my-post-grid-slider-swiper' ];
	}
	public function get_script_depends() {

        return [ 'my-js-post-grid-slider', 'my-js-post-grid-slider-swiper'];
    }
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#fff',
                'selectors' => [
                    '{{WRAPPER}} .eael-grid-post-slider-holder' => 'background-color: {{VALUE}}',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .eael-grid-post-slider' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .eael-grid-post-slider-holder' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .eael-grid-post-slider-holder',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::DIMENSIONS,
                'selectors' => [
                    '{{WRAPPER}} .eael-grid-post-slider-holder' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .eael-grid-post-slider-excerpt p' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .eael-grid-post-slider-excerpt p' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .eael-grid-post-slider-excerpt p',
            ]
        );
        ...
        $this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .eael-grid-post-slider-holder .eael-entry-wrapper' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .eael-grid-post-slider .eael-entry-overlay' => 'background-color: {{VALUE}}',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#ffffff',
                'selectors' => [
                    '{{WRAPPER}} .eael-grid-post-slider .eael-entry-overlay > i' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .eael-grid-post-slider .eael-entry-overlay > i' => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .eael-grid-post-slider .eael-entry-overlay > img' => 'height: {{SIZE}}{{UNIT}}; width: {{SIZE}}{{UNIT}};'
                ],
            ]
        );
                ...
                jQuery(document).ready(function() {
                    jQuery(".eael-post-grid").each(function() {
                        ...
                        var $gallery = jQuery(".eael-post-grid", $scope).isotope({
                            itemSelector: ".eael-grid-post-slider",
                            masonry: {
